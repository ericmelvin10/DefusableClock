...
/*
  ...
  En mi diseño, hay que cortar los cables en un orden determinado para desactivarla.
...
#define DEFAULT_COUNTDOWN_DURATION 1200 //(20 minutos)
#define TRIGGER_DURATION_MS 10000
...
void countdown() {
  ...
  //defusePin = WIRE_2;   //defuse wire
  //detPin = WIRE_1;      //detonation wire
  ...
  while ((countdownSeconds > 0) && (!defused))  {
    for(int i=0;i<10000;i++) {
      ...
      //si corta el pin 2 entra en modo secuencia
